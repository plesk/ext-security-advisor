...
$messages = [
    ...
    'list.wordpress.notAllowed' => 'The WordPress Toolkit is not allowed by the license key.',
    ...
    'controllers.system.aiDesc' => 'Install nginx to make HTTP/2 available. To install nginx, select nginx web server in Web hosting group in Plesk Installer. HTTP/2 improves performance; specifically, end-user perceived latency, network and server resource usage.',
    ...
    'controllers.system.googleauthenticatorDesc' => 'Google Authenticator add a 2 Factor Authentication (2FA) to the login of your Plesk instance.',
